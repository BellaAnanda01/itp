    ...
    <div>
      <div style={{backgroundImage: `url(${background})`, backgroundAttachment: "scroll", backgroundSize: 'cover', backgroundPosition: "bottom center", minHeight: "100vh"}}>
        <div style={{
          ...
          <p style={{lineHeight: "24px"}}>Silakan bergabung dengan grup WhatsApp berikut:<br/><Link target="_blank" to={localStorage.getItem('tipetiket') === "Offline" ? "https://chat.whatsapp.com/C9qH4i2u1zpHjntRDZI5yS" : "https://chat.whatsapp.com/D6JenRUzBTV7m2oZIctCEa"}><span style={{padding: "1.5px"}}><b>{localStorage.getItem('tipetiket') === "Offline" ? "https://chat.whatsapp.com/C9qH4i2u1zpHjntRDZI5yS" : "https://chat.whatsapp.com/D6JenRUzBTV7m2oZIctCEa"}</b></span></Link></p>
          <p>Contact Person: <br/>
