    ...
    <div>
      <div style={{backgroundImage: `url(${background})`, backgroundAttachment: "scroll", backgroundSize: 'cover', backgroundPosition: "bottom center", minHeight: "100vh"}}>
        <div style={{
          ...
          <p style={{lineHeight: "24px"}}>Silakan bergabung dengan grup WhatsApp berikut:<br/><Link target="_blank" to={localStorage.getItem('tipetiket') === "Offline" ? "https://chat.whatsapp.com/C9qH4i2u1zpHjntRDZI5yS" : "https://chat.whatsapp.com/D6JenRUzBTV7m2oZIctCEa"}><span style={{padding: "1.5px", textDecoration: "underline", color: "#0563C1"}}>{localStorage.getItem('tipetiket') === "Offline" ? "https://chat.whatsapp.com/C9qH4i2u1zpHjntRDZI5yS" : "https://chat.whatsapp.com/D6JenRUzBTV7m2oZIctCEa"}</span></Link></p>
          <p>Contact Person: <br/>
