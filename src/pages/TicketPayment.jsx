      ...
      <div style={{backgroundImage: `url(${background})`, backgroundAttachment: "scroll", backgroundSize: 'cover', backgroundPosition: "top center", minHeight: "100vh"}}>
          ...
          <div style={{display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "8px", marginTop: "15px"}}>
            ...
            <p style={{
              ...
              marginLeft: '5px',
              marginBottom: "10px"
            }}>Bukti pembayaran<br/><span style={{lineHeight: '0',fontSize: "14px", margin: "0"}}>Yang harus dibayar: {localStorage.getItem('tipetiket') === "Offline" ? "Rp55.000" : localStorage.getItem('tipetiket') === "Online" ? "Rp37.000" : "Loading..."}</span></p>
          </div>
