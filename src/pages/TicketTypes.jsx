                ...
                <Div>
                    ...
                    <SecondDivTickets>
                        <SecondDivTicketsBackground>
                            ...
                            <button onClick={(e) => buttonValue(e, 'Offline')} style={{fontFamily: "'Sniglet', cursive", textAlign: "center", margin: 0, backgroundColor: "#ff4747", color: "white", padding: "8px", borderRadius: "8px"}}>SOLD OUT</button>
                        </SecondDivTicketsBackground>
                        <SecondDivTicketsBackground>
                            <SecondDivTicketsH style={{color: "#2f6eed"}}>Open House</SecondDivTicketsH>
                            <SecondDivTicketsP style={{marginBottom: 0}}>Sabtu, 11 November 2023</SecondDivTicketsP>
